...
public class CreateEmpleadoController extends HttpServlet {
	...
	protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		String dpto_id = req.getParameter("dpto_id");
		...
		if(dpto_id== null || "".equals(dpto_id)) {
			errores.add("Departamento id vacío");
		}
		...
		try {
			...
			Departamento dpto = dptoDAO.getById(Long.parseLong(dpto_id));
			
			e = new Empleado(Long.parseLong(dni),nombre,apellido,dpto);
			dao.create(e);
